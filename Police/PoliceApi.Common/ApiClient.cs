...
namespace PoliceApi
{
    public class ApiClient : IApiClient
    {
        ...
        private HttpClient CreateClient()
        {
            ...
            //Need to be able to load the below from the configuration of the application.
            //This would allow the PoliceApi service to talk to https://data.police.uk/api/ and
            //Should allow a desktop application to use the same code to talk to this PoliceApi service
            //client.BaseAddress = new Uri(apiConfiguration.BaseApiUrl)
            //client.BaseAddress = new Uri("https://data.police.uk/api/");
            //
            //More complete solution would be to allow a class to pass in the information
            //to the Uri/use Uri builder and always construct the client base address to the resource
            //we wish to use
